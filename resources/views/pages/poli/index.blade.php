        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            ...
            <div class="relative mx-4 mt-4 overflow-hidden text-slate-700 bg-white rounded-none bg-clip-border">
                <div class="flex items-center justify-between ">
                    <div>
                        <h3 class="text-lg font-semibold text-slate-800">Daftar Poliklinik</h3>
                        <p class="text-slate-500">Tinjau setiap data sebelum mengedit</p>
                    </div>
                    <div class="flex flex-col gap-2 shrink-0 sm:flex-row">
                        ...
                        <a href="{{ route('poli.create')}}">Tambah Poliklinik</a>
                        </button>
                    </div>
                </div>
            </div>
                                ...
                                <tr>
                                    <td class="p-4 border-b border-slate-200">
                                        ...
                                        <img src="https://demos.creative-tim.com/test/corporate-ui-dashboard/assets/img/team-3.jpg"
                                            ...
                                            <p class="text-sm font-semibold text-slate-700 tooltip" title="{{ $item->nama_poli }}">
                                                {{ $item->nama_poli ? (strlen($item->nama_poli) > 10 ? substr($item->nama_poli, 0, 10) . '...' : $item->nama_poli) : '' }}
                                            </p>
                                        </div>
                                    </td>
                                    <td class="p-4 border-b border-slate-200">
        ...
        <div id="deleteModal" class="fixed inset-0 flex items-center justify-center bg-black bg-opacity-50 hidden">
            <div class="bg-white rounded-lg p-6 w-1/3">
                ...
                <div class="flex justify-end">
                    ...
                    <form method="POST" action="{{ route('poli.delete', $item->id) }}">
                        @csrf
                        @method('DELETE')
                        <button 
                            type="submit" 
