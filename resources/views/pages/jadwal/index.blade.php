        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            ...
            <div class="relative mx-4 mt-4 overflow-hidden text-slate-700 bg-white rounded-none bg-clip-border">
                <div class="flex items-center justify-between ">
                    <div>
                        <h3 class="text-lg font-semibold text-slate-800">Jadwal Periksa</h3>
                                ...
                                <tr>
                                    ...
                                    <td class="p-4 border-b border-slate-200">
                                        <div class="w-max">
                                            <div
                                                class="relative grid items-center px-2 py-1 font-sans text-xs font-bold text-indigo-900 uppercase rounded-md select-none whitespace-nowrap bg-indigo-500/20">
                                                <span class="">{{ $item->jam_mulai }}</span>
                                            </div>
                                        </div>
                                    </td>
                                    <td class="p-4 border-b border-slate-200">
                                        <div class="w-max">
                                            <div
                                                class="relative grid items-center px-2 py-1 font-sans text-xs font-bold text-indigo-900 uppercase rounded-md select-none whitespace-nowrap bg-indigo-500/20">
                                                <span class="">{{ $item->jam_selesai }}</span>
                                            </div>
                                        </div>
                                    </td>
                                    <td class="p-4 border-b border-slate-200">
        ...
        <div id="deleteModal{{ $item->id }}" class="fixed inset-0 flex items-center justify-center bg-black bg-opacity-50 hidden">
            <div class="bg-white rounded-lg p-6 w-1/3">
                ...
                <div class="flex justify-end">
                    ...
                    <form method="POST" action="{{ route('jadwal.delete', $item->id) }}">
                        @csrf
                        @method('DELETE')
                        <button 
                            type="submit" 
