        ...
        <div class="flex justify-between h-16">
            <div class="flex">
                ...
                @switch(session()->get('status'))
                    ...
                    @case(2)
                        <div class="hidden space-x-8 sm:-my-px sm:ms-10 sm:flex">
                            <x-nav-link href="{{ route('pasien.index-by-doctor') }}" :active="request()->routeIs('pasien.index-by-doctor')">
                                {{ __('Pasien') }}
                            </x-nav-link>
                        </div>
                        <div class="hidden space-x-8 sm:-my-px sm:ms-10 sm:flex">
                    ...
                    @case(3)
                        <div class="hidden space-x-8 sm:-my-px sm:ms-10 sm:flex">
                            <x-nav-link href="{{ route('daftar-poli.index') }}" :active="request()->routeIs('daftar-poli.index')">
                                {{ __('Pendaftaran') }}
                            </x-nav-link>
                        </div>
                        @break
